...
#import "RegisterLiteViewController.h"
#import "UIButton+Bootstrap.h"
@interface RegisterLiteViewController ()
//重点说明
...
@implementation RegisterLiteViewController
    ...
    @try{
        if([_RegAction isEqualToString:@"0"]){
            ...
            if ([resultCodeObj intValue]==1) {
                //成功注册！
                NSString *strTitleMsg = [[NSString alloc] initWithFormat:@"您已成功注册！您可以通过找回密码功能修改登录密码，您的初始密码是: %@",_username];
